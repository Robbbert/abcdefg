...
uint8_t sfkick_state::ppi_port_b_r()
{
	switch(m_input_mux & 0x0f)
	{
		...
		case 2: return bitswap<8>(m_dial->read(), 4, 5, 6, 7, 3, 2, 1, 0)^0xff; // 2024-02-24 Robbbert MT08825; fix direction of bat
...
static INPUT_PORTS_START( sfkick )
	...
	PORT_START("DIAL")
	PORT_BIT( 0xff, 0x00, IPT_DIAL ) PORT_SENSITIVITY(25) PORT_KEYDELTA(20)  // 2024-02-24 Robbbert MT08825, turn left/right around to align with mouse
